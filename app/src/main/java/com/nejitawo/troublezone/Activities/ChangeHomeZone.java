...
public class ChangeHomeZone extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
...
final GlobalClass globalVariable = (GlobalClass)getApplicationContext();
          ...
          if (globalVariable.getHomeID()==1) {
              ...
              if (!txtHomeAddress.getText().toString().isEmpty()){
                  if (!txtLocation.getText().toString().isEmpty()){
                      ...
                      ringProgressDialog = ProgressDialog.show(ChangeHomeZone.this,"Please wait..","Setting your Home Zone");
    ...
    private void showSuccess(String message) {
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(ChangeHomeZone.this);
        builder.setMessage(message).setTitle("Success")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        // do nothing
                        //  createdoc();
                        Intent intent = new Intent(ChangeHomeZone.this,MainActivity.class);
...
protected synchronized void buildGoogleApiClient() {
        mGoogleApiClient = new GoogleApiClient.Builder(ChangeHomeZone.this)
...
final AlertDialog.Builder builder = new AlertDialog.Builder(ChangeHomeZone.this);
